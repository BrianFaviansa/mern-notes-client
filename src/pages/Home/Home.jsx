    ...
    <>
      ...
      <div className="container mx-auto">
        {allNotes.length > 0 ? (
          ...
          <EmptyCard imgSrc={addNotesImg} message={`Start creating your first note! click the 'Add' button to write down your thoughts, ideas, and reminders. Let's get started!`} />
        )}
      </div>
